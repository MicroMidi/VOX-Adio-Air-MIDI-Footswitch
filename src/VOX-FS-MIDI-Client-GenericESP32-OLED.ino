/**
   ...
   I adjusted it for the "VOX Adio Air" device and a generic ESP32 module. This version supports four buttons:
...
void loop()
{
  ...
  if (isConnected) {
    ...
    if (FirstRun == true && (millis() - t0) > 200) {
      ...
      display.drawString(0, 20, "VOX connected");
      display.display();
...
#ifdef PIN_VOLUME
  if (MIDIVolume >= 0)
    display.drawProgressBar(0, 50, 120, 10, map(MIDIVolume, 0, MAX_VOLUME, 0, 100));
#endif
